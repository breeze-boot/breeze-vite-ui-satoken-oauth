...
import { page, exportExcel, deleteCategory } from '@/api/flow/category'
import type { CategoryRecords } from '@/api/flow/category/type.ts'
import type { CategoryRecord, CategoryQuery } from '@/api/flow/category/type.ts'
...
const tableInfo = reactive<TableInfo>({
  ...
  tbHeaderBtn: [
    {
      type: 'primary',
      label: t('common.add'),
      permission: ['flow:category:create'],
      event: 'add',
      icon: 'add',
    ...
    },
    {
      ...
      permission: ['flow:category:delete'],
      event: 'del',
      icon: 'delete',
    ...
    },
    {
      ...
      permission: ['flow:category:export'],
  ...
  fieldList: [
    ...
    },
    {
      prop: 'tenantId',
      showOverflowTooltip: true,
      label: t('category.fields.tenantId'),
    },
  ],
  handleBtn: {
    minWidth: 400,
    ...
    btList: [
      // 编辑
      {
        ...
        icon: 'edit',
        event: 'edit',
        permission: ['flow:category:modify'],
