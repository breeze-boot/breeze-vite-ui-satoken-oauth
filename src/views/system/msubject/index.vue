...
import { page, exportExcel, deleteMSubject, open } from '@/api/system/msubject'
import type { MSubjectRecords } from '@/api/system/msubject/type.ts'
import type { MSubjectRecord, MSubjectQuery } from '@/api/system/msubject/type.ts'
import { TableInfo } from '@/components/Table/types/types.ts'
import AddOrEdit from './components/MSubjectAddOrEdit.vue'
import { Refresh, Search } from '@element-plus/icons-vue'
import { useI18n } from 'vue-i18n'
import SetUser from '@/views/system/msubject/components/SetUser.vue'
