...
import { EmailSetUserQuery } from '@/api/system/msubject/type.ts'
import { listToEmail, listCcEmail } from '@/api/system/msubject'
...
onMounted(async () => {
  ...
  queryParams.value.column = route.query.column
  await getInfo(route.query.id, route.query.column)
})
